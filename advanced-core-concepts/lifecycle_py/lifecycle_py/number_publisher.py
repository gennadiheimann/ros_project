...
from interfaces.msg import Number
...
class NumberPublisherNode(LifecycleNode):
  ...
  def on_configure(self, previous_state: LifecycleState):
    ...
    self.number_publisher_ = self.create_lifecycle_publisher(Number, "number", 10)
  ...
  # Destroy ROS2 communications, desconnect to HW
